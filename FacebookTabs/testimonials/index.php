...
<head>
	<meta charset="UTF-8">
    <title>What is Prism? &ndash; CenturyLink&reg; Prism&trade;</title>
			...
			<div class="videoLinks">
				...
				<ul>
					...
					<li class="video-thumb-love-features">
						<a href="#BqwzAoy7u1s" data-posterurl="http://<?php echo $_SERVER["SERVER_NAME"]; ?>/FacebookTabs/testimonials/images/video-poster-love-features.jpg">
							<span class="vidThumb ir"> click to play </span>
