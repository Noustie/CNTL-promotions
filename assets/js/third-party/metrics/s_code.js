...
function getAccount(sAccount,custClass){
	...
	if(typeof(custClass)!='undefined'&&custClass!=''){
		if(custClass=="business")return "clinkbusiness,clinkcompany";
		if(custClass=="consumer")return "clinkconsumer,clinkcompany";
	}
	if(pPath==""||
	pPath=="index.jsp"||
