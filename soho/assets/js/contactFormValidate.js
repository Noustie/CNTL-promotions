$(function () {
	...
	var config = {
		sel_mainForm: '#smbCallback',
		sel_toValidate: '#smbCallback .validate',
		...
		css_OnClean: { color: '#000000', border: '1px solid #999999' },
		css_OnGood: { color: '#00853F', border: "1px solid #00853F" },
