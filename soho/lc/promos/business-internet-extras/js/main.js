$(function(){
	...
	var tl = new TimelineMax({paused:true, repeat:5, yoyo:true});
	...
	tl_1.to($(".content-icon1"), .5, {backgroundPosition: '0px center'})
	.to($(".content-icon2"), .5, {backgroundPosition: '3px center'})
	.to($(".content-icon3"), .5, {backgroundPosition: '6px center'})
	.to($(".content-icon4"), .5, {backgroundPosition: '0px center'});
	...
	$(window).load(function () {
		...
		$('.content-icon3').waypoint(function() {
			tl_1.play();
			$('.content-icon3').waypoint('destroy');
		}, { offset: 'bottom-in-view'});
