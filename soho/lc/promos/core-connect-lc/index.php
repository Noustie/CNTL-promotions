...
Activity name of this tag: CTLSB - LC $105 CoreConnect Main LP
URL of the webpage where the tag is expected to be placed: https://promotions.centurylink.com/soho/lc/promos/core-connect-lc/
...
document.write('<iframe src="https://3490900.fls.doubleclick.net/activityi;src=3490900;type=landi831;cat=ctlsb411;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
</script>
<noscript>
<iframe src="https://3490900.fls.doubleclick.net/activityi;src=3490900;type=landi831;cat=ctlsb411;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
</noscript>
	...
	<div class="page_wrapper" >
		<div class="special-offers-left no-green-bg">
			<div class="headerBlock">
				...
				<h3>CENTURYLINK CORE CONNECT - As low as $105 per month for 12 months with 36-month agreement*</h3>
			</div>
		</div>
...
<?php
renderForm( "thankyou.php", "LC", "Core Connect", "105", "images/btn_talkToExpert.jpg", "", $addEmailField );
?>
