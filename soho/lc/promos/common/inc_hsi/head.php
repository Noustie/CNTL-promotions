...
<html lang="en-US">
<head>
<title>CenturyLink Business - Business-Class High-Speed Internet</title>
...
<link href="../common/hsi.css" rel="stylesheet" type="text/css">
...
<div id="main">
	<div id="masthead"> <a href="http://www.centurylink.com/small-business/"><img id="logo" src="/soho/assets/images/ctl_bus_logo/ctl_bus_logo.png" alt="CenturyLink"  style="padding-top:20px;"></a>
		<ul id="sectionNav">
			<li class="first"><a href="http://www.centurylink.com/wholesale">Wholesale</a></li>
			<li><a href="http://www.centurylink.com/Pages/Support/">Customer Support</a></li>
			<li><a href="http://www.centurylink.com/Pages/AboutUs/">About Us</a></li>
			<li><a href="https://eam.centurylink.com/eam/entryPoint.do">My Account</a></li>
		</ul>
	</div>
