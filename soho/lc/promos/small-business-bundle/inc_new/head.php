...
$metaTitle = '<title>CenturyLink | Small Business Bundle | All The Essentials. 1 Low Price.</title>';
$metaDescription = '<meta name="description" content="The CenturyLink Small Business Bundle gives businesses an edge with High-Speed Business Internet, Business Email, Web Hosting, Design and Business Voice." />';
...
<?php if(!isset($metaTitle)){ $metaTitle = '<title>CenturyLink | Small Business Bundle | All The Essentials. 1 Low Price.</title>';} echo $metaTitle;?>
<?php if(!isset($metaDescription)){ $metaDescription = '<meta name="description" content="The CenturyLink Small Business Bundle gives businesses an edge with High-Speed Business Internet, Business Email, Web Hosting, Design and Business Voice." />';} echo $metaDescription;?>
