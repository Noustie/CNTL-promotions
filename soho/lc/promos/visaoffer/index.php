...
$metaTitle = '<title>High-Speed Internet | CenturyLink | Small-Medium Business | Special Offers</title>';
...
eBiz_pageName="ctl|smb|promos|special_offers|ctl_29.99_HSI";
...
eBiz_evar55=eBiz_prop27="ctl|smb|promos|special_offers|ctl_29.99_HSI";
...
?>
	...
	<div id="pageWrapper" class="ccSave ccTrustSave page_wrapper page_wrapper_top widepage internetLC">
		<div>
			<div class="headerBlock visa-10mbps-girl">
				<h1>GET PAID TO GO FASTER.</h1>
				<h6>Get $100 Visa Gift Card Order High-Speed Business Internet Today!</h6>
				<h3>$29.99 PER MONTH* | UP TO 10 MBPS</h3>
				<h6>New internet customers for 12 months with a 36-month term.</h6>
			</div>
			<a href="/soho/lc/promos/visaoffer/disclaimer.html" class="header-disclaimer-link" onclick="window.open(this.href,'disclaimer','height=650,width=600,left=100,top=50,resizable=no,scrollbars=yes,toolbar=no,status=no');return false;" target="_blank">
...
<!-- 		<div id="underForm" class="roundcorners rcHasBdr">
		...
		<div id="pageContent">
			...
			<div id="coreConnectBundle">
				<h2>CenturyLink<sup>&reg;</sup> High-Speed Business Internet gives you an edge:</h2>
				<ul class="internetAdvantage">
					<li>Do more faster with speeds up to 10 Mbps</li>
					<li>Blazing-fast upgrades up to 25 Mbps</li>
			...
			<div id="smilingBox">
				<div class="smilingBoxWrap internet-page">
					...
					<p>CenturyLink small business products and services help businesses succeed &ndash; and are designed to grow as your business grows. It's one of many reasons why more than 500,000 small businesses trust CenturyLink.</p>
