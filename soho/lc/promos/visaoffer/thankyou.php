...
eBiz_pageName="ctl|smb|promos|special_offers|ctl_29.99_HSI|thank_you";
...
eBiz_evar55=eBiz_prop27="ctl|smb|promos|special_offers|ctl_29.99_HSI|thank_you";
...
<div class="trackWrap">
	...
	Activity name of this tag: CTLSB - Generic HSI Conversion Page - LCTL
	URL of the webpage where the tag is expected to be placed: https://promotions.centurylink.com/soho/lc/promos/internet/thankyou.php?success=true&r=1352151779
	This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
	Creation Date: 11/05/2012
	-->
	<!--
	<iframe src="https://3490900.fls.doubleclick.net/activityi;src=3490900;type=confi440;cat=ctlsb558;qty=1;cost=[Revenue];ord=[OrderID]?" width="1" height="1" frameborder="0" style="display:none"></iframe>
