...
?>
	...
	<div id="pageWrapper" class="ccSave ccTrustSave page_wrapper page_wrapper_top widepage internetLQ">
		<div>
			<div class="headerBlock visa-12mbps-girl">
				<h1>High Speed BUSINESS INTERNET</h1>
				<h6>Special offer for small businesses: Get $100 Visa Gift Card Order High-Speed Business Internet Today!</h6>
