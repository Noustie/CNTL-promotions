...
if( $_GET['source']=="display" && $_GET['zone']=="hc" ) {
	...
	$pagePhone = "877.299.0960";
} else if ( $_GET['source']=="search" ){
	$pagePhone = "877.523.5939";
...
eBiz_pageName="ctl|smb|promos|special_offers|q_20_price_lock_lock_it_down";
...
eBiz_evar55=eBiz_prop27="ctl|smb|promos|special_offers|q_20_price_lock_lock_it_down";
