...
$(function(){
	$("#nav a:eq(0)").attr('clicktrack','qwest|smb|mid_upper_educational|landing|rba|small_nav_1');
	$("#nav a:eq(1)").attr('clicktrack','qwest|smb|mid_upper_educational|landing|rba|small_nav_2');
	$("#nav a:eq(2)").attr('clicktrack','qwest|smb|mid_upper_educational|landing|rba|small_nav_3');
});
