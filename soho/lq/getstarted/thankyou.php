...
Activity name of this tag: CTLSB - Default LQ Confirmation
URL of the webpage where the tag is expected to be placed: http://promotions.centurylink.com/soho/lc/getstarted/
This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
Creation Date: 04/19/2012
-->
<iframe src="https://fls.doubleclick.net/activityi;src=3490900;type=confi440;cat=ctlsb356;qty=1;cost=[Revenue];ord=[OrderID]?" width="1" height="1" frameborder="0" style="display:none"></iframe>
...
<div id="main">
	<div id="masthead"><a href="http://www.centurylink.com/small-business/" target="_blank"><img id="logo" src="../images/ctl_bus_logo/ctl_bus_logo.png" alt="CenturyLink"></a>
		...
		<h2 class="callToday">Call today! 855.693.4162</h2>
	</div>
	<div class="page_wrapper corners outsideW">
		...
		<div class="pageMain">
				...
				<div class="product">
					...
					<div class="prodOffer">
						<div class="pricePoint">
							<h4 class="pricePointText"><span class="sup">$</span><span class="bigPrice">85</span><span class="sup">*</span></h4>
						</div>
						<small>per month with 36-month term. <br />
							Up to 12 Mbps.</small>
			...
			<p class="disclaimer"><small>*Other fees and conditions may apply. <a href="http://www.centurylink.com/small-business/disclaimers/" onclick="window.open(this.href,'disclaimer','height=600,width=900,left=100,top=50,resizable=no,scrollbars=yes,toolbar=no,status=no');return false;">View details.</a></small></p>
		</div>
