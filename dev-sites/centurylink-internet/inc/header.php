...
Activity name of this tag: CenturylinkInternet.com - Non Secure
URL of the webpage where the tag is expected to be placed: http://centurylinkinternet.com/
...
-->
    ...
    document.write('<iframe src="http://2660564.fls.doubleclick.net/activityi;src=2660564;type=landi947;cat=Centu0;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
    </script>
    <noscript>
    <iframe src="http://2660564.fls.doubleclick.net/activityi;src=2660564;type=landi947;cat=Centu0;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
    </noscript>
