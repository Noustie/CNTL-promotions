				...
				<div class="content">
					...
					<div id="tabs" class="homeTabsWrap">
						...
						<div id="lrgBizTab" class="tab">
							<p>A trusted technology partner to dynamic corporations in every industry, CenturyLink is a visionary cloud provider and leader in hosted IT solutions with data centers around the world. <a class="lrgBizBtn" href="?x=large_business#">Watch Large Business</a> </p>
						</div>
						<div id="smBizTab" class="tab">
							<p>CenturyLink gives small business advanced tools that power growth. Our customers also have access to local experts providing support every step of the way. <a class="smBizBtn" href="?x=small_medium_business#">Watch Small Business</a></p>
						</div>
						<div id="govTab" class="tab">
							<p>As your agency's trusted technology partner, CenturyLink provides access to a visionary cloud infrastructure and custom communications solutions backed by dedicated, responsive support. <a class="govBizBtn" href="?x=government#">Watch Government</a></p>
						</div>
					</div> <!-- end tabs -->
