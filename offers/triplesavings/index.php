...
$fb_url = 'http://' . $_SERVER['SERVER_NAME'] . '/offers/triplesavings/index.php';
...
$twt_url = 'http://' . $_SERVER['SERVER_NAME'] . '/offers/triplesavings/';
...
$svar = array(
	'pageName' => "ctl|rsd|product|emktg|lctl_3_year_pricelock_lite",
	'server' => "promotions.centurylink.com",
	'channel' => "rsd",
	'prop24evar53' => "rsd|product",
	'prop25evar54' => "rsd|product|emktg",
	'prop26evar55' => "rsd|product|emktg|lctl_3_year_pricelock_lite",
	'prop38evar48' => "static_page",
	'prop39evar49' => "landing_page",
	'c2c_clickTrack' => 'ctl|rsd|product|emktg|lctl_3_year_pricelock_lite|click_to_chat'
);
...
<?php require_once("../common/dtv-triple/includes/head.php") ?>
	<div id="main" role="main" class="corners outsideW">
		<div class="page-content">
			<div class="pageHeader">
				...
				<div class="headCta">
					<h2 class="abir">3 services. 3 years. 1 bundled monthly price. Guaranteed.</h2>
					<h3 class="abir">$99 <small>a month for 36 months. After bill credits, with 24-month DIRECTV agreement.** Excludes all additional monthly fees, surcharges and taxes.*</small></h3>
					<div id="<?php echo $c2c_buttonname; ?>" class="chatBtn"> </div>
				</div>
				<h3 class="snipe ir">NEW!</h3>
				<h4 class="call">Or call <strong>1.855.621.8922</strong> now!</h4>
			</div>
			<div class="pageCta">
				...
				<h4 class="call">Or call <strong>1.855.621.8922</strong></h4>
			</div>
			<div class="tabs">
				<ul class="tabsNav">
	...
	<div class="pageSubFoot">
		<p class="discliamer col">Other fees and conditions may apply. <a class="popupTrigger" target="_blank" href="disclaimer.html">Click here for details.</a><br>
			<br />
			Offer ends 7/31/13. New approved customers only. Conditions apply. 24-month DIRECTV agreement required.**  <br />
