<?php
$fb_title = '3 services. 3 years. 1 monthly price.';
$fb_url = 'http://' . $_SERVER['SERVER_NAME'] . '/offers/triple/index.php';
$fb_image = 'http://' . $_SERVER['SERVER_NAME'] . "/offers/common/dtv-triple/img/fb.jpg";
$fb_description = 'Now from CenturyLink, bundle 3 services &ndash; DIRECTV&reg; service, High-Speed Internet and Home Phone &ndash; and lock in your price for 3 years!';

$twt_url = 'http://' . $_SERVER['SERVER_NAME'] . '/offers/triple/';
$twt_text = 'Now from CenturyLink, bundle 3 services &ndash; DIRECTV&reg;, Internet and Home Phone &ndash; and lock in your price for 3 years!';

$page_keywords = 'centurylink internet, internet service, internet service provider, High Speed Internet, fast internet, centurylink price lock offer, centurylink 3 year deal, triple play, internet phone tv bundle, directv, phone service provider';
$page_description = "Get the CenturyLink Price Lock Guarantee.  Bundle Home Phone and High-Speed Internet with 140 DIRECTV channels and a monthly price that won't increase for 3 years.  Guaranteed.";
$page_title = 'CenturyLink Triple Price Lock. DIRECTV, Internet &amp; Phone, all in one bundle.';

$svar = array(
	'pageName' => "ctl|rsd|product|emktg|lq_3_year_pricelock_lite",
	'server' => "promotions.centurylink.com",
	'channel' => "rsd",
	'prop24evar53' => "rsd|product",
	'prop25evar54' => "rsd|product|emktg",
	'prop26evar55' => "rsd|product|emktg|lq_3_year_pricelock_lite",
	'prop38evar48' => "static_page",
	'prop39evar49' => "landing_page",
	'c2c_clickTrack' => 'ctl|rsd|product|emktg|lq_3_year_pricelock_lite|click_to_chat'
);
	...
	<div id="main" role="main" class="corners outsideW">
		<div class="page-content">
			<div class="pageHeader">
				...
				<div class="headCta">
					<h2 class="abir">3 services. 3 years. 1 bundled monthly rate. Guaranteed.</h2>
					<h3 class="abir">$99.95 <small>a month for 36 months. After bill credits, with 24-month DIRECTV agreement.** Excludes all additional monthly fees, surcharges and taxes.*</small></h3>
					<div id="<?php echo $c2c_buttonname; ?>" class="chatBtn"> </div>
				</div>
				<!-- <h3 class="snipe ir">NEW!</h3> -->
				<h4 class="call">Or call <strong>1.877.529.3404</strong> now!</h4>
			</div>
			<div class="pageCta">
				...
				<h4 class="call">Or call <strong>1.877.529.3404</strong></h4>
			</div>
			<div class="tabs">
				<ul class="tabsNav">
					...
					<li><a href="#calling">Local Calling</a></li>
				</ul>
				<div class="tabsCont">
					...
					<div id="pricelock" class="tab bgright">
						<div class="tabPad">
							...
							<p>Now you can bundle <strong>DIRECTV<sup>&reg;</sup></strong> service, <strong><br>High-Speed Internet</strong> and <strong>Home Phone</strong> from CenturyLink &ndash; all for a low price that you can lock in for 3 years! One low bundled monthly rate, locked in for 3 years, with free standard professional installation of your<br>DIRECTV<sup>&reg;</sup> System.</p>
						</div>
					</div>
					<div id="directv" class="tab bgleft">
						<div class="tabPad">
...
<span style="font-size:10px;line-height:12px;">Additional equipment required. Additional &amp; Advanced receiver fees apply. Minimum 2-room set-up required for free Genie upgrade offer.</span> </li>
					...
					<div id="hsi" class="tab bgright">
						<div class="tabPad">
							...
							<ul>
								<li>Connection speeds at 1.5 Mbps to download, upload, surf, watch and chat</li>
					...
					<div id="calling" class="tab bgleft">
						<div class="tabPad">
							<br />
							<br />
							<br />
	...
	<div class="pageSubFoot">
		<p class="discliamer col">Other fees and conditions may apply. <a class="popupTrigger" target="_blank" href="http://www.centurylink.com/common/disclaimers/triple_bundle_offer.html">Click here for details.</a> <br>
			<br />
			...
			Applicable use tax adjustment may apply on the retail value of the installation.</p>
