<?php
    ...
    $shadow_styles = "tall";
    $javascriptFile = "cities"; //omaha
    $chatbtn = true;
    $title = "CenturyLink | Fiber Internet Omaha | 1 Gigabit High Speed Internet";
    $description = "CenturyLink Fiber 1 Gig Internet in Omaha gives you the power to connect all your devices, stream multiple HD movies at once & more.";
    $keywords = "centurylink, centurylink fiber, 1 gig internet, Omaha internet, high speed internet";
...
<!--             <div class="cities-flare particle1"></div>
        ...
        <div class="mid-cta">
            <div class="tfn fL">Call Now! 855-838-5465</div>
            <div id="lp-chat-residential-english-gpon-ma-modal" class="chat fR"></div>
            ...
            <script type="text/javascript">
                ...
                if(typeof(lpMTagConfig1.dynButton)!="undefined") {
                    lpMTagConfig1.dynButton[lpMTagConfig1.dynButton.length] = {'name':"chat-residential-english-gpon-ma-modal",'pid':'lp-chat-residential-english-gpon-ma-modal'};
                }
            </script>
        </div>
        ...
        <div class="city">
            <div class="title-selection">
                <h3 class="fL">Omaha Residential Pricing</h3>
                <div class="selection fR">
                    <span>Select a City:&nbsp;&nbsp;</span>
                    <select name="cities" onchange="location = this.options[this.selectedIndex].value;">
                        <option value="Nebraska - Omaha" selected>Nebraska - Omaha</option>
                        <option value="<?php echo $path; ?>/cities/las-vegas-nevada">Nevada - Las Vegas</option>
                    </select>
                </div>
                <div style="clear:both;"></div>
            </div>
            <div class="pricing">
                <div class="fL price-point tier3">
                    ...
                    <div class="price-area">
                        ...
                        <span class="price"><sup>$</sup>149<sup>94</sup></span>
                ...
                <div class="fL price-point tier2">
                    ...
                    <div class="price-area">
                        ...
                        <p class="above-price">Starting at</p>
                        <span class="price"><sup>$</sup>99<sup>95</sup></span>
            ...
            <div class="expanded">
                <div class="pos">
                    ...
                    <p><a href="http://www.centurylink.com/prismtv/#index.html" class="linkout" target="_blank" style="padding-top:5px;" clicktrack="ctl|rsd|emktg|offers|gigabit|cities|omaha|link|prism"><strong>Learn More</strong> <img src="<?php echo $path; ?>/img/linkout.png"></a></p>
                </div>
            </div>
            <div class="small-disclaimer">
                <a href="<?php echo $path; ?>/cris-disclaimer.html" onclick="window.open(this.href,'disclaimer','height=650,width=970,left=100,top=50,resizable=no,scrollbars=yes,toolbar=no,status=no');return false;" target="_blank">Offer details</a>
            </div>
            ...
            <div class="store">
                ...
                <div class="find-store fL">
                    ...
                    <a href="http://storelocator.centurylinkapps.com/index.cfm" target="_blank" class="bookendButton" title="Find a CenturyLink store near you" clicktrack="ctl|rsd|emktg|offers|gigabit|cities|omaha|link|store">
