...
?>
    <div class="base news">
        ...
        <div class="news-paper">
            ...
            <h2>News</h2>
		<h3>CenturyLink to make Omaha one of the fastest broadband cities in America</h3>
		<span class="date">05/01/13</span>
		<p>
			<strong>OMAHA, Neb.</strong>, May 1, 2013 -- CenturyLink, Inc. (NYSE: CTL) today announced it is connecting 48,000 Omaha homes and businesses with its new high-speed fiber network pilot that will deliver Internet speeds of up to one Gigabit per second (Gbps) – 100 times faster than average broadband speeds.
		</p>
        <p>
...
CenturyLink is the third largest telecommunications company in the United States and is recognized as a leader in the network services market by technology industry analyst firms. The company is a global
leader in cloud infrastructure and hosted IT solutions for enterprise customers. CenturyLink provides data, voice and managed services in local, national and select international markets through its high-quality advanced fiber optic network and multiple data centers for businesses and consumers. The company also offers advanced entertainment services under the CenturyLinkTMPrismTM TV and DIRECTV brands. Headquartered in Monroe, La., CenturyLink is an S&amp;P 500 company and is included among the Fortune 500 list of America's largest corporations. For more information, visit <a href="http://www.centurylink.com" target="_blank">www.centurylink.com</a>.
        </p>
	</div>
</div>
