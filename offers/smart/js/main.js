...
$(function(){
	...
	if ( !!document.createElement('canvas').getContext && !!document.createElement('canvas').getContext('2d')) {
		...
		tl_demo.staggerTo( heroDevices, 0.5, { opacity:0, ease:Power2.easeOut }, 0.3)
				...
				.to($(".hero-back-btn"), 0.7,{alpha: 1, ease:Power2.easeInOut}, 0.8);
	} else {
		//TIMELINES FOR IE 8
		tl_start.staggerTo( heroDevices, 0.7, { opacity:1, ease:Power2.easeOut }, 0.3)
	...
	$(".emanagement").click(function(e){
	    ...
	    $('.benefits-content .mini-nav ul li').removeClass('mini-nav-active');
	    $('.benefits-content .caps .middle').addClass('mini-nav-active');
	    $('ul#nav li > a').removeClass('active');
	    $('ul#nav li a#benefits-btn').addClass('active');
	    $('.expansion-link').removeClass('active');
	    $(this).parent().children().addClass('active');
	...
	plansTl.to($(".plans .dot-bar"), 1, {top:-91, ease:Linear.easeNone}, "label1")
		   ...
		   .to($(".plan-tile2-a1"), .8, {top:-373, opacity:1, autoAlpha:1, ease:Linear.easeNone}, "label1")
		   ...
		   .to($(".plan-tile3-a4"), .8, {top:320, opacity:1, delay:0.4, ease:Linear.easeNone}, "label2")
		   .to($(".plan-tile3-a3"), .8, {top:427, opacity:1, delay:0.7, ease:Linear.easeNone}, "label2")
		   .to($(".plan-tile3-a5"), .8, {top:540, opacity:1, delay:0.9, ease:Linear.easeNone}, "label2")
	...
	$(".pricing").click(function(e){
	    ...
	    $('.plans-content .caps .first').addClass('mini-nav-active');
	    $('ul#nav li > a').removeClass('active');
	...
	$(".installation").click(function(e){
	    ...
	    $('.plans-content .mini-nav ul li').removeClass('mini-nav-active');
	    $('.plans-content .caps .middle').addClass('mini-nav-active');
	    $('ul#nav li > a').removeClass('active');
	    $('ul#nav li a#plans-btn').addClass('active');
	    $('.expansion-link').removeClass('active');
	    $(this).parent().children().addClass('active');
   	...
   	$(".equipment").click(function(e){
	    ...
	    $('.plans-content .mini-nav ul li').removeClass('mini-nav-active');
	    $('.plans-content .caps .last').addClass('mini-nav-active');
	    $('ul#nav li > a').removeClass('active');
	    $('ul#nav li a#plans-btn').addClass('active');
	    $('.expansion-link').removeClass('active');
	    $(this).parent().children().addClass('active');
	...
	$("a.snipe-disclaimer").colorbox({inline:true, width:"780px"});
	...
	//nav drop downs
	$(".nav-expansion").hide();
    $("#demo-btn, .home-exp").hover(
		function() {
		    $(".nav-expansion.home-exp").stop(true,false).slideToggle("fast");
		}
	);
	$("#benefits-btn, .benefits-exp").hover(
		function() {
		    $(".nav-expansion.benefits-exp").stop(true,false).slideToggle("fast");
		}
	);
	$("#plans-btn, .plans-exp").hover(
		function() {
		    $(".nav-expansion.plans-exp").stop(true,false).slideToggle("fast");
		}
	);
