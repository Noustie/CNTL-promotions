...
$(function(){
	...
	if ( !!document.createElement('canvas').getContext && !!document.createElement('canvas').getContext('2d')) {
		...
		tl_start.to( $(".lady"), 0.5, { alpha:1, ease:Power2.easeOut })
				...
				.from($(".limited-time-offer-snipe"), 0.7,{ backgroundPosition:"-380px 0px", ease:Power2.easeInOut}, .9)
				.to($(".limited-time-offer-snipe a"), 0.7,{ opacity:1, ease:Power2.easeInOut}, 1.2);
