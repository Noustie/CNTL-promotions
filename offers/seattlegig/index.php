    ...
    <body>
	    ...
	    <div class="row">
	    	<div class="content footer">
	    		...
	    		<p>**Other fees and conditions may apply. <a onclick="window.open(this.href,'disclaimer','height=500,width=800,left=100,top=50,resizable=no,scrollbars=yes,toolbar=no,status=no');return false;" target="_blank" href="./disclaimer.php" clicktrack="ctl|rsd|emktg|mdu_seattle|link|details">Click here</a> for details.</p>
	    		<br/>
				<div class="nav grey">
					<ul>
