...
/*** Start of Butler Till's DoubleClick Floodlight Tag: Activity name of this tag: CTL HSI Check Availability Page URL of the webpage where the tag is expected to be placed: https://www.centurylink.com/shop/Internet/HSI/availability.html Creation Date: 01/22/2010 ***/
...
/*** GLOBAL Floodlight/DART tag **/
	...
	// remove after 4/1/2011
	$('#menu a').each( function(index) {
		if ( $(this).text() == "Tom Gerke" ) {
			$(this).parent().hide();
		}	
	})
