...
/*** Start of Butler Till's DoubleClick Floodlight Tag: Activity name of this tag: CTL HSI Check Availability Page URL of the webpage where the tag is expected to be placed: //www.centurylink.com/shop/Internet/HSI/availability.html Creation Date: 01/22/2010 ***/
if(location.pathname=="/shop/Internet/HSI/availability.html"){
	if($('h1:contains(Check Internet Access Availability in Your Area)').length>0){
		var axel = Math.random() + "";
		var a = axel * 10000000000000;
		document.write('<iframe src="//fls.doubleclick.net/activityi;src=2417582;type=shopi232;cat=hsict030;ord=1;num=' + a + '?" width="1" height="1" frameborder="0"></iframe>');
	}
}
...
function dblClck_btnClick() {
	...
	var tag_url="//fls.doubleclick.net/activityi;src=2417582;type=cavail;cat=embar703;ord=1;num="+Math.floor(Math.random()*999999);
...
function genFloodlight_onClick(srcStr) {
	var axel = Math.random() + "";
	var a = axel * 10000000000000;
	var tag_url="//fls.doubleclick.net/activityi;" + srcStr + a + "?";
