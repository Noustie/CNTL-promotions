<?php
$page_keywords = 'high speed internet bundle, internet offer, high speed internet, CenturyLink internet offer, 100 Mbps, fast internet, internet Seattle, internet Minneapolis, 3-year price lock guarantee, 30-Day satisfaction guarantee, fast upload speed fast download speeds';
...
<head>
    ...
    <body>
	    ...
	    <div class="row">
	    	<div class="content choose-it">
	    		<p class="green">Choose the speed that's right for you.<br/><span class="grey reg">Compare our Internet speeds.</span></p>
	    	</div><!--end content div-->
	    </div><!--end row div-->
	    	...
	    	<div class="content chart">
	    		<div class="specs orange-chart fL">
		    		...
		    		<div class="sec2">
		    			...
		    			<div style="clear:both;"></div>
		    			<p class="white price-lock-text"><strong>3-Year Price-Lock Guarantee</strong></p>
		    		</div>
		    		<div class="sec3">
	    		...
	    		<div class="specs orange-chart fL">
		    		...
		    		<div class="sec6">
		    			<img class="fL" src="img/camera-dl.png" alt="" />
		    			<p class="fL">UPLOAD 200 PHOTOS<br/>(300 MB)<br/><span class="bold speed">1 MINUTE</span></p>
		    			<div style="clear:both;"></div>
		    		</div>
		    		<div style="clear:both;"></div>
	    		</div>
	    		...
	    		<div class="specs green-chart fL">
		    		...
		    		<div class="sec6">
		    			<img class="fL" src="img/camera-dl.png" alt="" />
		    			<p class="fL">UPLOAD 200 PHOTOS<br/>(300 MB)<br/><span class="bold speed">1.3 MINUTES</span></p>
		    			<div style="clear:both;"></div>
		    		</div>
		    		<div style="clear:both;"></div>
	    		</div>
	    		
	    		<div class="specs green-chart fL last">
		    		<div class="sec1">
		    			...
		    			<div class="bar-wrapper">
			    			<div class="bar-bottom short-bar">
				    			<div class="bar-middle four grey">
				    				<div class="bar-top short-bar">
				    				</div>
				    			</div>
			    			</div>
	    		...
	    		<div style="clear:both;"></div>
	    		<div class="small-text"><p>Times calculated March 2013 using http://www.calctool.org/CALC/prof/computing/transfer_time.</p></div>
	    ...
	    <div class="row">
	    	<div class="content guarantees">
	    		<div class="fL module">
	    			<div class="mod-img"><img class="module-img-1" src="img/price-lock-guarantee.png" alt="CenturyLink Price-Lock Guarantee" /></div>
	    			<h3 class="green">3-Year Price-Lock Guarantee</h3>
	    			<p class="grey">You can relax knowing your price will not change for 5 years. 5 years. 1 price. 0 contract.<br/>No surprises.</p>
	    		</div>
	    		<div class="fL module">
	    	...
	    	<div class="content footer">
				...
				<div class="nav grey">
					<ul>
	    				...
	    				<li>|</li>
	    				<li><a href="https://www.centurylink.com/business/" title="" target="_blank">Large Business</a></li>
	    				<li>|</li>
