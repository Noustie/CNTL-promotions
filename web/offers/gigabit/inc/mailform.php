<?php
	...
	try {  
		...
		$dbname = "c1vegasgpon";
		$user = "c1gpon";
		$pass = "8Jwn6e526322R8AFq4j41D7B78955WjI";
		...
		# named placeholders 
		$STH = $con->prepare("INSERT INTO CNTL_1GIG_VEGAS_INQUIRY (name, streetAddress, unitNumber, zip, email, phone) value (:name, :streetAddress, :unitNumber, :zip, :email, :phone)");  
