...
/* 
CURRENTLY TESTING EMAIL SETUP FOR MAILGUN
...
$emailDomain = "contactcenturylink.net";
$emailU = "postmaster@contactcenturylink.net";
$emailP = "4ak9ljtvrmg3";
...
function SendEmail( SOHOFormData $formData, $email_TO, $email_FROM, $email_HOST, $email_UN, $email_PW, $email_DOMAIN = null, $email_PORT = 587 )
{
	...
	$smtp = Mail::factory('smtp', array ('host' => $email_HOST, 'domain' => $email_DOMAIN, 'port' => $email_PORT, 'auth' => true, 'username' => $email_UN, 'password' => $email_PW));
...
if ( $formData->isValidSubmitData() ) {
	SendEmail( $formData, $emailsTo["".$formData->legacy_market.""], $emailFrom, $emailHost, $emailU, $emailP, $emailDomain );
