...
eBiz_evar54=eBiz_prop26="ctl|smb|promos|special_offers|q_triple_business_bundle";
eBiz_evar55=eBiz_prop27="ctl|smb|promos|special_offers|q_triple_business_bundle|thank_you";
...
Activity name of this tag: CTLSB - LQ - DTV Bundle Confirmation
URL of the webpage where the tag is expected to be placed: https://promotions.centurylink.com/soho/lq/promos/DTVbundle/thankyou.php
This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
Creation Date: 02/06/2013
-->
<iframe src="https://3490900.fls.doubleclick.net/activityi;src=3490900;type=confi440;cat=ctlsb345;qty=1;cost=[Revenue];ord=[OrderID]?" width="1" height="1" frameborder="0" style="display:none"></iframe>
