...
<?php if(!isset($metaTitle)){ $metaTitle = '<title>20Mbps for $20 Special Offer | Small-Medium Business | CenturyLink</title>';} echo $metaTitle;?>

<?php if(!isset($metaDescription)){ $metaDescription = '<meta name="description" content="Lock down fast High-Speed Internet for $20 a month for 3 years from CenturyLink Small-Medium Business. Reliable service and low pricing." />';} echo $metaDescription;?>

<?php if(!isset($metaKeywords)){ $metaKeywords = '<meta name="keywords" content="CenturyLink Small Business, CenturyLink SMB, Phone and Internet, Business Solutions, Business Internet & Data, Enhanced Business Services, Business Phone, Business Mobile, business communication services, telecommunication solutions, networking, Business Bundles, business phone services, small business it, office services, price-lock, guarantee"/>';} echo $metaKeywords;?>
