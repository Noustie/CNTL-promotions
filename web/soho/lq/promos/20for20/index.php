            ...
            <div class="content c960">
                <div class="float-left">
                    <div class="info">
                        ...
                        <p class="disclaimer">*Other fees and conditions may apply. <a href="http://www.centurylink.com/small-business/disclaimers/" onclick="window.open(this.href,'disclaimer','height=650,width=970,left=100,top=50,resizable=no,scrollbars=yes,toolbar=no,status=no');return false;" target="_blank">View details.</a></p>
                    </div>
                </div>
...
<!--                     <div id="underForm">
        ...
        var default_number='8008318045'; /* 10 Digits Only i.e. 8881234567 */
