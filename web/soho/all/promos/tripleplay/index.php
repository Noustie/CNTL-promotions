<?php
    $pagePhone = "866.400.9201";
    $svar = array(
            'pageName' => "ctl|smb|soho|promos|dtv|triple_play",
...
<!DOCTYPE html>
    <head>
        ...
        <title>CenturyLink | Small-Medium Business | CoreConnect + DIRECTV</title>
        <meta name="description" content="Bundle High-Speed Internet, phone, web hosting, email and DIRECTV service through CenturyLink Small-Medium Business. Reliable service and low pricing.">
    ...
    <!--<![endif]-->
        ...
        <div class="wrapper">
            ...
            <div class="hero c960">
                <h2>
                    <img src="img/hero.jpg" alt="Call now and ask how to get NFL Sunday Ticket at no extra charge. Build your fan base with Business Internet + Voice + DIRECTV.">
                </h2>
            </div>
            <div class="content c960">
                <div class="float-left">
                    <div class="info">
                        <h2>Put the ultimate business bundle to work for your company.</h2>
                        <ul class="img-list">
                            <li class="hsi">
                                <h4>High-Speed Internet</h4>
                                <p>Do more, faster with speeds up to 20 Mbps.</p>
                            </li>
                            <li class="wp">
                                <h4>Web Presence</h4>
                            ...
                            <li class="bv">
                                <h4>Business Voice</h4>
                                <p>Stay in touch locally and nationwide with popular calling features.</p>
                            </li>
                            <li class="ds">
                        ...
                        <div class="lower-tfn">
                            <p class="orange">Call <?php echo $pagePhone; ?> to score a great deal<br>on Business Internet &amp; Voice + DIRECTV for Business.</p>
                        </div>
                ...
                <div class="float-right">
                    <div class="badge">
                        <h1>Business Internet &amp; Voice Directv Business Information&reg; Package</h1>
                        <p class="hide-me">$99.99/mo.* For 12 months. With Auto Bill Pay and Bundle offer discounts. Requires a 24-month Directv and 36-Month CenturyLink agreement.</p>
