<?php
    $pagePhone = "866.602.8496";
    $svar = array(
            'pageName' => "ctl|smb|soho|promos|dtv",
...
<!DOCTYPE html>
    <head>
        ...
        <meta name="description" content="Stay infromed by adding DIRECTV for Business to your current CenturyLink services. Reliable service and low pricing.">
    ...
    <!--<![endif]-->
        ...
        <div class="wrapper">
            ...
            <div class="hero c960">
                <h2>
                    <img src="img/hero.jpg" alt="Call now and ask how to get NFL Sunday Ticket at no extra charge. Entertain your team by adding DIRECTV to your business.">
                </h2>
            </div>
            <div class="content c960">
                <div class="float-left">
                    <div class="tv">
                        <p>DIRECTV for business</p>
                    </div>
                    <div class="info">
                        ...
                        <div class="lower-tfn">
                            <p class="orange">Call <?php echo $pagePhone ?> to score a great deal<br>on DIRECTV for Business.</p>
                        </div>
                ...
                <div class="float-right">
                    <div class="badge">
                        <h1>DIRECTV Business information&reg; package.</h1>
                        <p class="hide-me">$24.99/mo.* For 12 months. With Auto Bill Pay and Bundle offer discounts. Requires a 24-month term.</p>
