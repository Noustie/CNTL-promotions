...
if(typeof s_accountOverride === "string" && s_accountOverride != "")
	...
	if((locURL.indexOf("iot.centurylink.com") == -1) && (locURL.indexOf("shop.centurylink.com") == -1) && (locURL.indexOf("www.centurylink.com") == -1)
			&& (locURL.indexOf("c.myaccount.centurylink.com") == -1) && (locURL.indexOf("qwest.centurylink.com") == -1)
...
s.linkInternalFilters="javascript:,interprise,uswest,lci,ridethelight,cybersolutions,northwesternbell,litel,qwestinteractive.com,highway,qintra.com,qwest.connectutilities.com,interact.kefta.com,qwest.groovemobile.net,qwest.com,qwestapps.com,techzillabyqwest.com,qwestaffiliateoffers.com,qwestcampaigns.com,qwestbestoffers.com,insideconnection.com,incredibleinternet.com,qwestwifilocator.com,centurylink.com,qwestwifilocator.com,qhelp.com,.centurylink.com"
