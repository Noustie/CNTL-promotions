...
Activity name of this tag: CTLSB - Bundle1($95)
URL of the webpage where the tag is expected to be placed: http://www.centurylink.com/smallbusiness/promos/bizbundle1.jsp
This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
Creation Date: 01/09/2012
-->
<iframe src="https://fls.doubleclick.net/activityi;src=3490900;type=landi831;cat=ctlsb652;ord=<?php echo rand(1000000000000, 10000000000000) ?>?" width="1" height="1" frameborder="0" style="display:none"></iframe>
