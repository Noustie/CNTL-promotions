...
$metaTitle = '<title>Core Connect from CenturyLink | Small-Medium Business | Special Offers</title>';
$metaDescription = '<meta name="description" content="Get High-Speed Internet, phone, web hosting and email from CenturyLink Small-Medium Business, at speeds up to 25 Mbps. Reliable service and low pricing." />';
$metaKeywords = '<meta name="keywords" content="CenturyLink Small Business, CenturyLink SMB, Phone and Internet, Business Solutions, Business Internet & Data, Enhanced Business Services, Business Phone, Business Mobile,  Business TV, business communication services, telecommunication solutions, networking, Orlando Small Business, Orlando Internet, Business Bundles, business phone services, small business it, office services" />';

$omnitureVars = <<<OMNIVARS
eBiz_server="promotions.centurylink.com";
eBiz_pageName="ctl|smb|promos|special_offers|ctl_orlando_core_connect";
...
eBiz_evar55=eBiz_prop27="ctl|smb|promos|special_offers|ctl_orlando_core_connect";
		...
		<div class="special-offers-form">
			<div class="cta">
				<div class="ctaTop">
					<div class="ctaMid">
						<div class="ctaBody">
							<h2 class="accentForm" style="font-size:14px;">Talk to an Orlando Rep Today.</h2>
							<p>Fill out the form below and a local Business Expert will call or meet you to discuss how we can help your business.</p>
							<p class="smaller">(All fields required.)</p>
<?php
renderForm( "thankyou.php", "LC", "Orlando", "Think you're stuck with cable? Think again.", "images/btn_talkToExpert.jpg", "ORL" );
?>
						</div>
					</div>
				</div>
