...
$footerLinks = array(
	...
	"Site Map" => "http://www.centurylink.com/sitemap.html",
	"Find a Store" => "http://storelocator.centurylinkapps.com/",
	"Contact Us" => "https://www.centurylink.com/small-business/support/"
	);
	

$omnitureVars = <<<OMNIVARS
eBiz_server="promotions.centurylink.com";
eBiz_pageName="ctl|smb|special_offers|lctl|core_connect|$95_thankyou";
...
eBiz_evar54=eBiz_prop26="ctl|smb|special_offers|lctl|core_connect|$95_thankyou";
eBiz_evar55=eBiz_prop27="ctl|smb|special_offers|lctl|core_connect|$95_thankyou";
...
Activity name of this tag: CTLSB - LC $95 CoreConnect Confirmation Page
URL of the webpage where the tag is expected to be placed: https://promotions.centurylink.com/soho/lc/promos/core-connect-mc/thankyou.php?/
This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
Creation Date: 02/15/2013
-->
<iframe src="https://3490900.fls.doubleclick.net/activityi;src=3490900;type=confi440;cat=ctlsb014;qty=1;cost=[Revenue];ord=[OrderID]?" width="1" height="1" frameborder="0" style="display:none"></iframe>
