 ...
 */
 ...
 var linkMatrix={"zam":{
	...
	"hp-quicklink-email-create-account":{
		CTL: "http://www.centurylink.net",
		Q: "https://kai03.qwest.com/quickconnect/Activate/en/CommonContent.aspx?hc=Welcome-GetMyQwestLogin&s=13966169&p=432&k=05898ce4-17f2-4802-a279-681478b389c0&d=dotnot&t=60&pct=0"
	},
	...
	"home-sitemap-smb-faqs":{
		CTL: ctl_url+ "/smallbusiness/customer-support/",
...
"ctam":{
	...
	"home-bundles-threepane-internet-button-start-now":{
		EC:{
			type:'TCAT',
			CTL: ctl_url+"/shop/Bundles/index.html",
			Q: qshop_url+"/MasterWebPortal/residential/bundleslanding?Internet=true&DirecTv=true",
			EQ: eq_url+"/Residential/Voice/BundledServices",
			topicName: "shopBundlesResidential"
		},
		NC:{
			type:'TCAT',
			CTL: ctlsecure_url+"/MasterWebPortal/freeRange/centurylink/ShopDoubleBundle?Internet=true",
			Q: qshop_url+"/MasterWebPortal/residential/bundleslanding?Internet=true&DirecTv=true",
			EQ: eq_url+"/Residential/Voice/BundledServices"
		}
	},
	...
	"home-bundles-threepane-internet-button-start-now":{
		EC:{
			type:'TCAT',
			CTL: ctl_url+"/shop/Bundles/index.html",
			Q: qshop_url+"/MasterWebPortal/residential/bundleslanding?DIRECTV=D:6451387&Internet=true",
			EQ: eq_url+"/Residential/Voice/BundledServices",
			topicName: "shopBundlesResidential"
		},
		NC:{
