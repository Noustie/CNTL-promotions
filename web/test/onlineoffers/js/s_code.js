...
function getAccount(sAccount,custClass){
	...
	if(xTnTCookie=="true"||!location.host.match(/www.centurytel.com|www.centurylink.com|business.centurytel.com|centurylink-business.com|eam.centurylink.com|promotions.centurylink.com|centurylinkinternet.com|centurylinkonlineoffers.com/))return "clinkdev"; 
	if(!!location.host.match(/staging./))return "clinkdev"; 
	if(!!location.href.match(/soho/)) custClass="business"; 
...
if(typeof eBiz_prop35 != 'undefined' && eBiz_prop35)s.prop35=eBiz_prop35;
...
if(typeof eBiz_evar60 != 'undefined' && eBiz_evar59)s.eVar60=eBiz_evar60;
if(typeof eBiz_events != 'undefined' && eBiz_evar59)s.events=eBiz_events;
