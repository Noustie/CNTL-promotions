...
$fb_url = 'http://' . $_SERVER['SERVER_NAME'] . '/offers/student/index.php';
$fb_image = 'http://' . $_SERVER['SERVER_NAME'] . "/offers/student/images/fb.jpg";
$fb_description = 'get consistently fast CenturyLink High-Speed Internet for just $34.95 a month, no phone line required. it&rsquo;s internet that gives you what you need when you need it.';

$twt_url = 'http://' . $_SERVER['SERVER_NAME'] . '/offers/student/';
$twt_text = 'get consistently fast CenturyLink High-Speed Internet for just $34.95 a month, no phone line required!';
...
$page_description = "Get Pure Broadband from CenturyLink. High-Speed Internet with no phone line for only $34.95/mo. Lock in your price for 12 months.  With Pure Broadband  you can video chat with friends and family instantly";
$page_title = 'CenturyLink fast Broadband for homework and surfing the web.';

$svar = array(
	'pageName' => "ctl|rsd|product|emktg|t2_2012|college_pure|lqwest12months",
	...
	'c2c_clickTrack' => 'ctl|rsd|product|emktg|t2_2012|college_pure_l_qwest_12mo|button|clicktochat',
	'fbTrack' => 'ctl|rsd|product|emktg|t2_2012|college_pure_l_qwest_12mo|button|facebook',
	'twtTrack' => 'ctl|rsd|product|emktg|t2_2012|college_pure_l_qwest_12mo|button|tweet'
);
$headInsert = <<<HDINS
		...
		<div class="page-content">
			...
			<div class="college-student">
				...
				<div class="txtAndButton">
					...
					<h3>speeds up to 12 mbps $34.95 <small>a month for 12 months.</small></h3>
			...
			<div class="middle">
				...
				<p>order today and get high-speed internet, pure and simple, no phone line required. plus, this isn't any old internet you're getting. Pure Broadband&trade; from CenturyLink, designed to give you consistent speed everytime you log on, so you can:</p>
				<div class="grey-grad">
					<ul>
