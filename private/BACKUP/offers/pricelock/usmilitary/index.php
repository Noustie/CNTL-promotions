...
<title>CenturyLink | Get up to $5 Off Internet Service with our military discount</title>
<meta name="Description" content="CenturyLink proudly offers those in the United States Armed Forces up to a $5 discount on High-Speed Internet, up to 12 Mbps. And this is a price that lasts for 5 years! Check out this deal and our other military discounts now!">
                        ...
                        <div id="tabCont">
                            <div id="offerTabOneTab" class="offerTabOneTab speed tabin active">
                                <div class="tabContent">
                                    <div class="tabcopy">
                                        <h3>For those in the Armed Forces, staying connected to friends and family is more important than ever.</h3>
...
<!-- 						<div id="chatBtn" class="chatBtn"></div> -->
						<div class="get-net-now">
							<a href="http://www.centurylink.com/home/internet/">
...
<!--                    <div class="rightfootCol">
                ...
                <div class="disclaimer" style="clear: both;">*Other fees and conditions may apply. 
                	<a href="http://www.centurylink.com/common/popups/residential/pricing_details_popup.html" target="_blank" onclick="javascript:window.open(this.href,'disclaimer','height=600,width=800,left=100,top=50,resizable=no,scrollbars=yes,toolbar=no,status=no');return false;">Click here for details.</a>
