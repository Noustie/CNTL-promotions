...
<meta name="Description" content="CenturyLink proudly offers those in the United States Armed Forces up to $5 off a month on High-Speed Internet, with speeds up to 10 Mbps. And with the Price-Lock Guarantee, you can lock into a low monthly price for 5 years! Check out offers now!">
        ...
        <div class="nojs">
            <div id="pureWrapper">
                ...
                <div id="offerWrap" class="message messageBG">
                                ...
                                <div class="tabContent">
                                    <div class="tabcopy">
                                        ...
                                        <ul>
                                        	...
                                        	<li><span style="color: #00853f;">Ask about our Price-Lock guarantee &ndash; 5 years. 1 price. No term commitment.</span></li> 
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="rightRail">
						<h3 class="ir">CenturyLink&trade; High-Speed Internet</h3>
