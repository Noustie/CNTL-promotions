...
$fb_description = 'Now from CenturyLink, bundle 3 services &ndash; DIRECTV&reg; service, High-Speed Internet and Home Phone &ndash; and lock in your price for 3 years! Plus, get a $' . $price . ' Reward Card!';

$twt_url = 'http://' . $_SERVER['SERVER_NAME'] . '/offers/tripleplay/';
$twt_text = 'Now from CenturyLink, bundle 3 services and get a price that won&rsquo;t change for 3 years and a $150 Reward Card!';
...
$page_description = 'Get the CenturyLink Price Lock Guarantee and receive a $' . $price . ' Amex Reward Card.  Includes Home Phone, up to 10 Mbps High-Speed Internet and over 140 DIRECTV channels, locked into a low monthly rate for 3 years. No rising rates. Guaranteed. ';
	...
	<div id="main" role="main" class="corners outsideW">
		<div class="page-content">
			<div class="pageHeader">
				...
				<div class="headCta">
					<h2 class="abir">Bundle all 3 services and get a $150 value Reward Card*</h2>
