...
$fb_description = 'get consistently fast CenturyLink High-Speed Internet for just $39.95 a month, no phone line required. it&rsquo;s internet that gives you what you need when you need it.';

$twt_url = 'http://' . $_SERVER['SERVER_NAME'] . '/offers/collegeoffer/';
$twt_text = 'get consistently fast CenturyLink High-Speed Internet for just $39.95 a month, no phone line required!';
...
$page_description = "Pure Broadband from CenturyLink offers High-Speed Internet without a phone line. Lock in your price of $39.95/mo. for 12 months. With Pure Broadband  you can video chat with friends and family instantly";
		...
		<div class="page-content">
			...
			<div class="college-offer-header">
				...
				<div class="txtAndButton">
					...
					<h3>speeds up to 10 mbps $39.95 <small>a month for 12 months.</small></h3>
					<div id="<?php echo $c2c_buttonname; ?>" class="college-chatBtn-39"> </div>
				</div>
			</div>
			<div class="middle">
