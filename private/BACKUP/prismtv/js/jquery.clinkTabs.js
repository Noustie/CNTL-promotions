(function applyClinkTabs ( window, $ ){

	$.fn.clinkTabs = function clinkTabs ( options ) {
		var $main = $(this);

		var settings = {};
			settings.prevBtn = '<a href="#prev" class="prev">&laquo;</a>';
			settings.nextBtn = '<a href="#next" class="next">&raquo;</a>';
			settings.content = ".slideContent";
			settings.active = "sliderActive";
			settings.item = "";
			settings.speed = 400;
			settings.hideSpeed = 50;
			settings.numVisible = 3;
			settings.itemPad = 0;
			settings.height = 0;
