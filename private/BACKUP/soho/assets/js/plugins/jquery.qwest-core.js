			...
			zam:{
				...
				profile:function(data){
					...
					if(data.errorCode == 'UNEXPECTED') {
						...
						s.prop52=s.eVar56="ctl";
						s.prop3=s.eVar24="unknown";
						s.prop4=eVar28="locator - registry - zam - [UNEXPECTED] - [n/a]";
						s.events="event34";
						s.eVar60="zam:" + data.zipForFive; // Registry Type Detail
						s.prop51=eVar51="locator|zam"; // Registry Method
						s.t();
			...
			mam:{
				...
				preAuthByZip:function(){
					...
					if(zip.length > 0 && zip.length < 5) {
						...
						s.prop52=s.eVar56="ctl";
						s.prop3=s.eVar24="unknown";
						s.prop4=eVar28="mam - mya - [A zip code must contain 5 digits]";
						s.events="event34";
						s.eVar60="mam:" + data.zipForFive; // Registry Type Detail
						...
						s.prop52=s.eVar56="ctl";
						s.prop3=s.eVar24="unknown";
						s.prop4=eVar28="mam - mya - [A zip code is required]";
						s.events="event34";
						s.eVar60="zam:" + data.zipForFive; // Registry Type Detail
						s.prop51=eVar51="locator|mam"; // Registry Method
						s.t();
				...
				authExistingByMyAccount:function(){
					...
					if($('input[name="mam_company-selector-radio"]:checked').val() != 'undefined' && $('input[name="mam_company-selector-radio"]:checked').val() != null && profileData.shoppingDomainOverride == null) {
						...
						qm.options.cookieJar.bake('profile_cookie',profileData,0,"/","centurylink.com");
					}
