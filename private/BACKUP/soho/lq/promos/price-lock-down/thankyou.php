...
eBiz_pageName="ctl|smb|promos|special_offers|q_20_price_lock_lock_it_down|thank_you";
...
eBiz_evar55=eBiz_prop27="ctl|smb|promos|special_offers|q_20_price_lock_lock_it_down|thank_you";
...
Activity name of this tag: CTLSP - LQ- Price Lock Down Confirmation
URL of the webpage where the tag is expected to be placed: https://promotions.centurylink.com/soho/lq/promos/price-lock-down/
This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
Creation Date: 12/11/2012
-->
<iframe src="https://3490900.fls.doubleclick.net/activityi;src=3490900;type=confi440;cat=ctlsp899;qty=1;cost=[Revenue];ord=[OrderID]?" width="1" height="1" frameborder="0" style="display:none"></iframe>
...
<div class="page_wrapper_top widepage">
	...
	<div class="page_wrapper" >
		<div class="special-offers-left no-green-bg">
			...
			<h1>Tired of rising rates?</h1>
			<h6>Lock It Down with CenturyLink&reg; High-Speed Internet.</h6>
			<h2>$20 a month for 3 years.</h2>
	...
	<div id="main">
		<div id="lockInYourPrice">
			<h2>Now for business: 3 years of Internet savings. Lock it down.</h2>
			<h3>Introducing the CenturyLink Price-Lock Guarantee for Business</h3>
			<p>It's simple. You get 12 Mbps of High-Speed Internet with a locked-in price of $20 a month for 3 years when you bundle your services with Core Connect<sup>&reg;</sup>. So lock it down now, and get back to what's really important &ndash; your business.</p>
		</div>
