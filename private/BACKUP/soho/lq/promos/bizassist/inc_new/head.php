...
$metaTitle = '<title>Small Business Resource Center – Cloud Storage and Online Marketing – CenturyLink</title>';
$metaDescription = '<meta name="description" content="Elevate your small business potential with CenturyLink. Learn how with helpful videos and articles on marketing, technology, security, mobility and more." />';
$metaKeywords = '<meta name="keywords" content="CenturyLink Small Business, CenturyLink SMB, CenturyLink Business Help, CenturyLink Small Business Web Help, Business Web Help, Business Solutions, Business Internet, Business Web Hosting, CenturyLink Thank You Reward, Small business expert, CenturyLink web consultation, CenturyLink seo, CenturyLink social media, CenturyLink website, CenturyLink cloud services, cloud, cloud solutions, " />';


$omnitureVars = <<<OMNIVARS
eBiz_server="promotions.centurylink.com";
eBiz_pageName="qwest|smb|mid_upper_educational|landing";
eBiz_channel=eBiz_evar41="Small Business";
eBiz_prop3=eBiz_evar24="unknown";
eBiz_prop20="Business";
eBiz_evar35=eBiz_prop24="smb|mid_upper_educational";
...
<?php if(!isset($metaTitle)){ $metaTitle = '<title>Small Business Resource Center – Cloud Storage and Online Marketing – CenturyLink</title>';} echo $metaTitle;?>

<?php if(!isset($metaDescription)){ $metaDescription = '<meta name="description" content="Elevate your small business potential with CenturyLink. Learn how with helpful videos and articles on marketing, technology, security, mobility and more." />';} echo $metaDescription;?>

<?php if(!isset($metaKeywords)){ $metaKeywords = '<meta name="keywords" content="CenturyLink Small Business, CenturyLink SMB, CenturyLink Business Help, CenturyLink Small Business Web Help, Business Web Help, Business Solutions, Business Internet, Business Web Hosting, CenturyLink Thank You Reward, Small business expert, CenturyLink web consultation, CenturyLink seo, CenturyLink social media, CenturyLink website, CenturyLink cloud services, cloud, cloud solutions, "/>';} echo $metaKeywords;?>
