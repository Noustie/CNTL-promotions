			...
			<div class="ctaMid">
				<div class="ctaBody">
					<form id="kanaemail" name="kanaemail" action="/soho/util/getstarted-process.php" method="post" onsubmit="return chkData(this)">
						<input type="hidden" id="successView" name="successView" value="/soho/lq/getstarted/thankyou.php">
						<input type="hidden" id="legacyMarket" name="legacyMarket" value="LQ">
...
var default_number='8556934162'; /* 10 Digits Only i.e. 8881234567 */
