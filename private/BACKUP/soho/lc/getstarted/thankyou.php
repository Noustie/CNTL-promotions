...
Activity name of this tag: CTLSB - Default LCTL Confirmation Page
...
-->
<iframe src="https://fls.doubleclick.net/activityi;src=3490900;type=confi440;cat=ctlsb128;qty=1;cost=[Revenue];ord=[OrderID]?" width="1" height="1" frameborder="0" style="display:none"></iframe>
				...
				<div class="product">
					...
					<div class="prodOffer">
						<div class="pricePoint">
							...
							<img src="/soho/assets/images/getstarted/75-105.png" alt="$75 - $105" />
						</div>
