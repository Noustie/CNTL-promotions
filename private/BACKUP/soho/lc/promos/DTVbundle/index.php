<?php
$pagePhone = "866.602.8436";
$metaTitle = '<title>CenturyLink | Small-Medium Business | Special Offers | CoreConnect + DIRECTV</title>';
$metaDescription = '<meta name="description" content="Bundle High-Speed Internet, phone, web hosting, email and DIRECTV service through CenturyLink Small-Medium Business. Reliable service and low pricing." />';
...
eBiz_evar55=eBiz_prop27="ctl|smb|promos|special_offers|ctl_triple_business_bundle";
...
<?php
renderForm( "thankyou.php", "LC", "Core Connect + DIRECTV", '$99.99/MO. for 12 Months', "/soho/assets/images/cc-dtv-bundle/btn_talkToExpert.jpg", "Core Connect + DIRECTV - LCTL" );
?>
		...
		<div id="pageContent">
			...
			<div class="coreConnectInfo">
				...
				<div class="col leftCol ccInfo">
					<ul class="ccInfoList">
						<li> <strong>High-Speed INTERNET</strong> <span>Do more faster with speeds up to 10 Mbps and upgrades up to 25 Mbps.</span> <img src="/soho/assets/common/images/promos/icon-mouse.png" alt="High-Speed Internet" class="ccIcon" /></li>
						...
						<li> <strong>Business VOICE</strong> <span>Stay in touch locally and nationwide with up to 11 popular calling features.</span> <img src="/soho/assets/common/images/promos/icon-phone.png" alt="Business Phone Service" class="ccIcon" /> </li>
					</ul>
				</div>
