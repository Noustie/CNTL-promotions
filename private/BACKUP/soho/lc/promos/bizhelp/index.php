...
$viewOffer = "https://promotions.centurylink.com/soho/lc/promos/core-connect-lc/";

if ( $_GET['zone']=="lc" || $_GET['zone']=="mc" || $_GET['zone']=="hc" ) {
	$viewOffer = "https://promotions.centurylink.com/soho/lc/promos/core-connect-".$_GET['zone']."/";
} else if ( $_GET['zone']=="lc" && $_GET['topic']=="seo" || $_GET['zone']=="mc" && $_GET['topic']=="seo" || $_GET['zone']=="hc"&& $_GET['topic']=="seo" ){
	$viewOffer = "https://promotions.centurylink.com/soho/lc/promos/core-connect-".$_GET['zone']."&".$_GET['topic']."/";
...
Activity name of this tag: MidUpper Educational Landing Page LCTL 
URL of the webpage where the tag is expected to be placed: https://promotions.centurylink.com/soho/lc/promos/bizhelp/ 
...
document.write('<iframe src="https://3490900.fls.doubleclick.net/activityi;src=3490900;type=landi831;cat=midup204;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>'); 
</script> 
<noscript> 
<iframe src="https://3490900.fls.doubleclick.net/activityi;src=3490900;type=landi831;cat=midup204;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe> 
</noscript> 
...
<body>
	<div id="wrapper">
	    <div class="content header">
	    	<div class="logo fL">
	    		<a href="http://www.centurylink.com/small-business/" title="Century Link" target="_blank" onClick="_gaq.push(['_trackEvent', 'Index', 'Click',]);" clicktrack="ctl|smb|mid_upper_educational|landing|logo"><img src="img/century-link-logo.png" alt="Century Link Logo" /></a>
	    	</div>
	    ...
	    <div class="content">
	    	<div id="slider">
				<div id="social" class="one">
					...
					<a class='vid hero-link' href="//ad.doubleclick.net/clk;268958173;95054395;c?<?php echo $prot;?>//<?php echo $_SERVER["SERVER_NAME"]; ?>/soho/lc/promos/bizhelp/videoplayer.html?selectVideo=social" title="" onClick="_gaq.push(['_trackEvent', 'Slider', 'Click', 'Social Video Open']);" clicktrack="ctl|smb|mid_upper_educational|landing|rba|socialize_video"><img src="img/hero-3-link.png" alt="" /></a>			
				</div>
				
				<div id="cloud" class="two">
					<img src="img/hero2.jpg" alt="" width="958" height="390" />
					<span class="hero2-copy"></span>
					<a class='vid hero-link' href="//ad.doubleclick.net/clk;268956630;95054432;q?<?php echo $prot;?>//<?php echo $_SERVER["SERVER_NAME"]; ?>/soho/lc/promos/bizhelp/videoplayer.html?selectVideo=cloud" title="" onClick="_gaq.push(['_trackEvent', 'Slider', 'Click', 'Cloud Video Open']);" clicktrack="ctl|smb|mid_upper_educational|landing|rba|to_the_cloud_video"><img src="img/hero-2-link.png" alt="" /></a>
				</div>
				
				<div id="seo" class="three">
					<img src="img/hero3.jpg" alt="" width="958" height="390" />
					<span class="hero3-copy"></span>
					<a class='vid hero-link' href="//ad.doubleclick.net/clk;268958174;95054434;x?<?php echo $prot;?>//<?php echo $_SERVER["SERVER_NAME"]; ?>/soho/lc/promos/bizhelp/videoplayer.html?selectVideo=seo" title="" onClick="_gaq.push(['_trackEvent', 'Slider', 'Click', 'Seo Video Open']);" clicktrack="ctl|smb|mid_upper_educational|landing|rba|zero_to_hero_video"><img src="img/hero-1-link.png" alt="" /></a>
				</div>
				
			</div><!--end slider-->
			<div class="arrows"><a id="prev2" href="#" onClick="_gaq.push(['_trackEvent', 'Slider', 'Click', 'Previous Slide']);" clicktrack="ctl|smb|mid_upper_educational|landing|rba|advance_left">Prev</a> <a id="next2" href="#" onClick="_gaq.push(['_trackEvent', 'Slider', 'Click','Next Slide']);" clicktrack="ctl|smb|mid_upper_educational|landing|rba|advance_right">Next</a></div>
	    </div><!--end content div-->
	    ...
	    <div class="content yield">
    		<div class="fL text-content">
    			...
    			<div class="module">
    				...
    				<p>Small business owners like you work faster, smarter, harder and are always on the go. And, today's marketplace demands your online presence works just as hard. Whether you want &aacute; la carte small
business services, bundle savings or access to helpful business-building articles and videos, you can count on CenturyLink for help, 24/7. No wonder more than 200,000 businesses get their services from CenturyLink.</p>
    			</div>
...
<!-- 						<h3>To Elevate Your Small Business Potential, Start Here.</h3> -->
						...
						<div class="perimiter">
							...
							<div class="perimiter-text fL">
								...
								<ul id="changestate1" class="closed">
									<li>Keep projects moving with speeds up to 10 Mbps and additional upgrades up to 25 Mbps</li>
								...
								<a href="#" id="expandButton1" onClick="_gaq.push(['_trackEvent', 'Expand', 'Click', 'High-Speed Internet']);" clicktrack="ctl|smb|mid_upper_educational|landing|expand|high_speed_internet">Expand +</a>
								<a href="#" class="setit toggle-btn" onClick="_gaq.push(['_trackEvent', 'Expand', 'Click', 'High-Speed Internet']);" clicktrack="ctl|smb|mid_upper_educational|landing|expand|high_speed_internet"><img id="tog-img1" src="img/toggle-button.png" alt="" /></a>
							</div>
							<div style="clear:both;"></div>
						</div>
						...
						<div class="perimiter">
							...
							<div class="perimiter-text fL">
								...
								<a href="#" id="expandButton2" onClick="_gaq.push(['_trackEvent', 'Expand', 'Click', 'Web-hosting']);" clicktrack="ctl|smb|mid_upper_educational|landing|expand|website_hosting">Expand +</a>
								<a href="#" class="setit toggle-btn" onClick="_gaq.push(['_trackEvent', 'Expand', 'Click', 'Web-hosting']);" clicktrack="ctl|smb|mid_upper_educational|landing|expand|website_hosting"><img id="tog-img2" src="img/toggle-button.png" alt="" /></a>
							</div>
							<div style="clear:both;"></div>
						</div>
						...
						<div class="perimiter">
							...
							<div class="perimiter-text fL">
								...
								<a href="#" id="expandButton3" onClick="_gaq.push(['_trackEvent', 'Expand', 'Click', 'Business-class-email']);" clicktrack="ctl|smb|mid_upper_educational|landing|expand|business_class_email">Expand +</a>
								<a href="#" class="setit toggle-btn" onClick="_gaq.push(['_trackEvent', 'Expand', 'Click', 'Business-class-email']);" clicktrack="ctl|smb|mid_upper_educational|landing|expand|business_class_email"><img id="tog-img3" src="img/toggle-button.png" alt="" /></a>
							</div>
							<div style="clear:both;"></div>
						</div>
						...
						<div class="perimiter">
							...
							<div class="perimiter-text fL">
								...
								<a href="#" id="expandButton4" onClick="_gaq.push(['_trackEvent', 'Expand', 'Click', 'Business-Voice']);" clicktrack="ctl|smb|mid_upper_educational|landing|expand|business_voice">Expand +</a>
								<a href="#" class="setit toggle-btn" onClick="_gaq.push(['_trackEvent', 'Expand', 'Click', 'Business-Voice']);" clicktrack="ctl|smb|mid_upper_educational|landing|expand|business_voice"><img id="tog-img4" src="img/toggle-button.png" alt="" /></a>
							</div>
							<div style="clear:both;"></div>
						</div>
    		...
    		<div class="fL badge">
    			<div class="badge-content">
    				...
    				<a href="<?php echo $viewOffer; ?>" title="CenturyLink Core Connect Offers" target="_blank" onClick="_gaq.push(['_trackEvent', 'ViewOffer', 'Click', 'Offer Interest']);" clicktrack="ctl|smb|mid_upper_educational|landing|button|view_offers"><img src="img/offer-button.png" alt="" /></a>
