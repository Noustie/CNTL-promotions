...
function getAccount(sAccount,custClass){
	...
	if(xTnTCookie=="true"||!location.host.match(/www.centurytel.com|www.centurylink.com|business.centurytel.com|business.centurylink.com|eam.centurylink.com/))return "clinkdev"; 
	...
	}else if(location.host=="business.centurylink.com"||pPath.toLowerCase().indexOf("biz")!=-1||pPath.indexOf("usiness")!=-1){
...
function getChannel(sChannel) {
	...
	pPath.indexOf("AboutUs")!=-1){
		...
		return "Discover";
	}else if(pPath.indexOf("Support")!=-1||pPath.indexOf("CustomerService")!=-1||pPath=="rewardsLanding.html"){
		return "Support";
	}else{
		return "Shop";
	}
...
s.linkInternalFilters="javascript:,centurylink.,centurytel.,embarqmail.,synacor.,embarq.,speedpay.,mspcare.bcgi.,embarqnow."
...
/*****************************CTL CUSTOM CODE*********************************/
	...
	//plugin call for T&T > SiteCat integration (QC63/WCP 120910-15 10.30.2012)
	s.tnt=s.trackTNT();
...
if(eBiz_pageName)s.pageName=eBiz_pageName;
if(eBiz_server)s.server=eBiz_server
if(eBiz_channel)s.channel=eBiz_channel;
if(eBiz_hier1)s.hier1=eBiz_hier1;
if(eBiz_prop3)s.prop3=eBiz_prop3;
if(eBiz_prop6)s.prop6=eBiz_prop6;
if(eBiz_prop8)s.prop8=eBiz_prop8;
if(eBiz_prop20)s.prop20=eBiz_prop20;
if(eBiz_prop24)s.prop24=eBiz_prop24;
if(eBiz_prop25)s.prop25=eBiz_prop25;
if(eBiz_prop26)s.prop26=eBiz_prop26;
if(eBiz_prop27)s.prop27=eBiz_prop27;
if(eBiz_prop38)s.prop38=eBiz_prop38;
if(eBiz_prop39)s.prop39=eBiz_prop39;
if(eBiz_prop51)s.prop51=eBiz_prop51;
if(eBiz_prop52)s.prop52=eBiz_prop52;
if(eBiz_evar24)s.eVar24=eBiz_evar24;
if(eBiz_evar27)s.eVar27=eBiz_evar27;
if(eBiz_evar41)s.eVar41=eBiz_channel;
if(eBiz_evar48)s.eVar48=eBiz_evar48;
if(eBiz_evar49)s.eVar49=eBiz_evar49;
if(eBiz_evar51)s.eVar51=eBiz_evar51;
if(eBiz_evar53)s.eVar53=eBiz_evar53;
if(eBiz_evar54)s.eVar54=eBiz_evar54;
if(eBiz_evar55)s.eVar55=eBiz_evar55;
if(eBiz_evar56)s.eVar56=eBiz_evar56;
if(eBiz_evar59)s.eVar59=eBiz_evar59;
if(eBiz_evar60)s.eVar60=eBiz_evar60;
if(eBiz_events)s.events=eBiz_events;
