...
var lpMTagConfig = {
	...
	'defaultUnit' : 'smb-authentication'	
};
...
lpMTagConfig.dynButton[lpMTagConfig.dynButton.length] = { 'name': 'chat-residential-english-purecollege', 'pid': 'lpButton', 'afterStartPage': true };
